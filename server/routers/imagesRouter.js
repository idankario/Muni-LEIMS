...
ImagesRouter.post("/energyintensity",VerifyToken, ImagesCtl.insertEnergyIntensity);
...
ImagesRouter.patch("/disactive",VerifyToken, ImagesCtl.disactiveStatisticalReport);
